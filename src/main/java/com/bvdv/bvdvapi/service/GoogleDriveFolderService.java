...
import com.bvdv.bvdvapi.manager.GoogleFileManager;
import com.bvdv.bvdvapi.service.interfaces.IGoogleDriveFolder;
...
public class GoogleDriveFolderService implements IGoogleDriveFolder {
    ...
    @Override
    public List<File> listFolderContent(String folderId) throws IOException, GeneralSecurityException {
        return googleFileManager.listFolderContent(folderId);
    }
}